...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100">
      ...
      <aside
        className={`fixed lg:sticky lg:top-0 inset-y-0 left-0 z-40 w-72 h-screen bg-black border-r border-slate-800 transform transition-transform lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        ...
        <div className="p-4 border-t border-slate-800 bg-black-950/80 backdrop-blur-sm">
          <button
