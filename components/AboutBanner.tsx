import ButtonText from "./layout/ButtonText";
    ...
    return (
        <section className="my-12">
            <div className="flex flex-col lg:flex-row">
                ...
                />
                <div className="bg-[#F3F5F7] w-full lg:w-1/2">
                    <div className="my-14 mx-8 lg:my-40 lg:ml-20">
                        <h5 className="my-4 font-[550] text-3xl lg:text-5xl max-w-full md:max-w-[60%]">About us</h5>
