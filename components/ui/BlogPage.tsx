...
const BlogPage = () => {
    ...
    return (
        ...
        ${view === "grid3" ? "bg-gray-100 text-black" : "bg-white text-gray-500"}
        `}
                        >
                        ...
                        <button
                            ...
                            className={`text-xl px-4 py-2 border-r border-[#EAEAEA]
        ${view === "grid2" ? "bg-gray-100 text-black" : "bg-white text-gray-500"}
        `}
                        >
                            <BsFillGridFill />
                        </button>
        ...
        ${view === "grid1" ? "bg-gray-100 text-black" : "bg-white text-gray-500"}
        `}
                        >
                            <CiGrid2V />
                        </button>
        ...
        ${view === "list" ? "bg-gray-100 text-black" : "bg-white text-gray-500"}
        `}
                        >
                            <HiOutlineMenu />
                        </button>
                ...
                {visibleBlogs.map((blog, index) => (
                    ...
                    >
                        ...
                        <Image
                            src={blog.img}
                            alt={blog.title}
                            className={` ${(view === "list" || view === "grid1") ? "w-[200px] h-50" : "w-full h-90"}`}
                        /></Link>
