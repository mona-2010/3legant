...
const Footer = () => {
    return (
        <footer className="w-full bg-[#141718] px-[30px] md:px-[140px]">
            <div className="py-15 text-[#E8ECEF]">
                <div className="flex flex-col md:flex-row md:justify-between md:border-b-1 ">
                    <div className="flex flex-col text-center md:flex-row my-auto">
                        <p className="font-poppins text-center mx-auto font-medium text-2xl md:pr-8 md:my-auto md:border-r md:border-[#6C7275]">
                ...
                <div className="md:border-none border-t-2 md:border-[#6C7275] flex flex-col md:flex-row-reverse md:justify-between md:mt-4">
