...
const titlegrid = () => {
    return (
        <div className="mx-[30px] md:mx-[50px] lg:mx-[80px] xl:mx-[140px] flex flex-col justify-center md:items-center gap-4 md:gap-7 lg:gap-10 my-10 md:flex-row">
			...
			<div className="min-w-[40%]">
				<p className="text-[16px] md:text-[16px] text-gray-200">
